...
<div class="col-md-12 text-center">
	...
	<br><br><br>
		...
		<!-- 	<h1 class="footer-logo" style="color:#8C6239; font-size:1.5em;">
			...
			<!-- <p style="font-weight:bold; font-size:17px;">Get in touch</p> -->
			<p>Known Afrique LLP, <br>
			House no. B12,
			47 Makena,<br>
			Naivasha Road,<br>
			Off Riara Road Junction 
			</p>
			<p><a href="#">info@knownafrique.com</a><br>
			<a href="#">legal@knownafrique.com</a><br>
			<a href="#">office@knownafrique.com</a> 
			</p>
		</div>
		<div class="col-md-7">
		...
		<h4 style="color: rgba(171, 133, 25, 0.89); ">Lets get in touch!</h4>
		      <div class="col-lg-7 col-xs-6 text-center">
		          ...
		          <div class="form-group">
		              <textarea cols="80" class="form-control" name="comments" placeholder="Your Message *" id="message" required data-validation-required-message="Please enter a message."></textarea>
		              <p class="help-block text-danger"></p>
		          </div>
		      </div>
	...
	<br><br><br><br>
	<div class="col-md-12 text-center">
		<p>© Known Afrique LLP 2015 <br> Designed &amp; Developed by <a href="http://www.thedevschool.org/">thedev.shop</a></p>
	</div>
</div>

</footer>
<div class="overlay overlay-boxify" style="z-index: 500;">
<nav>
	<ul>
